    ...
    const pages = [
      ...
      const cpages = [
        ...
        {  offer:"no offers",
          ...
          {  offer:"36% off",
            name: "Sont PlayStation 4 slim  1 TB jet black ", 
      ...
      const Sellerpage = ({ showNav = true , showFoot = true }) => {
    ...
    return ( 
      ...
      <h2>  <p style={styles.description}> <h3>{pages.description} </h3></p>  </h2>
       <s> <p style={styles.cut} id="cut">{pages.cut}</p> </s> 
        <button id="bb1b">
        <Link to={pages.path} style={{ textDecoration: "none", color: "black" }}>SELL NOW</Link>
</button>
      </div>
    );
  })}
        ...
        return ( 
          ...
          <h2>  <p style={styles.description}> <h3>{cpages.description} </h3></p>  </h2>
           <s> <p style={styles.cut} id="cut">{cpages.cut}</p> </s> 
            <button id="bb1b">
            <Link to={cpages.path} style={{ textDecoration: "none", color: "black" }}>SELL NOW</Link>
    </button>
          </div>
        );
      })}
